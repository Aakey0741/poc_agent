...
const clientHF = new InferenceClient({ apiKey: HF_API_KEY });
...
async function generateSyntheticData() {
    const prompt = `Generate 5 employee records following this JSON Schema.
    IMPORTANT:
    ...
    const response = await clientHF.chat.completions.create({
        model: HF_MODEL,
